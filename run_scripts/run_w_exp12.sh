...
# python experiment_scripts/train_sdf_weights.py \
#     --point_cloud_path "mesh/exp10/ruyi_recur6_n_deformed_w.xyz" \
#     --experiment_name "exp10_7_v2" \
#     --checkpoint_path "logs/exp10/exp10_6/checkpoints/model_final.pth" \
#     --num_epochs 4000 \
#     --epochs_til_ckpt 500 \
#     --steps_til_summary 500
...
# python experiment_scripts/test_sdf.py \
#     --checkpoint_path "logs/exp10_7_lr-3/checkpoints/model_final.pth" \
#     --experiment_name "exp10_7_lr-3_rc"
...
#     --checkpoint_path /home/group1/jym/Repos/test_siren/logs/exp09_test91_e3k/checkpoints/model_final.pth \
#     --point_cloud_path mesh/exp09/ruyi_recur90_n_deformed_w.xyz
